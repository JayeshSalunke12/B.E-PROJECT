...
image_logo_large=ptk.PhotoImage(p.Image.open("Logo_Large.jpg"))
...
clicked_pest4.set("1kg – Rs.195")
clicked_pest5=StringVar()
clicked_pest5.set("25kg – Rs.500")
...
def GroceryCall():
    HideAllFrames()
    Grocery_Label=Label(Products_frame,text="Fertilizers",font="times 15 bold",fg="gold",bg="black").grid(row=0,column=0,padx=20)
...
def PesticidesCall():
    ...
    def AddG1():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Corn Flakes",GroceryPrice(clicked_pest1.get()),GroceryQty(clicked_pest1.get()),Spaces(40-len("Corn Flakes"))])
            messagebox.showinfo("Product Status","Kellogg's Corn Flakes Original ("+clicked_pest1.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Kellogg's Corn Flakes Original ("+clicked_pest1.get()+") is not added to the cart.")
    def AddG2():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Aashirwaad Atta",GroceryPrice(clicked_pest2.get()),GroceryQty(clicked_pest2.get()),Spaces(40-len("Aashirwaad Atta"))])
            messagebox.showinfo("Product Status","Aashirwaad Superior Atta ("+clicked_pest2.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Aashirwaad Superior Atta ("+clicked_pest2.get()+") is not added to the cart.")
    def AddG3():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Iodized Salt",GroceryPrice(clicked_pest3.get()),GroceryQty(clicked_pest3.get()),Spaces(40-len("Iodized Salt"))])
            messagebox.showinfo("Product Status","Tata Iodized Salt ("+clicked_pest3.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Tata Iodized Salt ("+clicked_pest3.get()+") is not added to the cart.")
    def AddG4():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Filtered Groundnut Oil",GroceryPrice(clicked_pest4.get()),GroceryQty(clicked_pest4.get()),Spaces(40-len("Filtered Groundnut Oil"))])
            messagebox.showinfo("Product Status","Safal Filtered Groundnut Oil ("+clicked_pest4.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Safal Filtered Groundnut Oil ("+clicked_pest4.get()+") is not added to the cart.")
    def AddG5():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Organic Toor Dal",GroceryPrice(clicked_pest5.get()),GroceryQty(clicked_pest5.get()),Spaces(40-len("Organic Toor Dal"))])
            messagebox.showinfo("Product Status","24 Mantra Organic Toor Dal ("+clicked_pest5.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","24 Mantra Organic Toor Dal ("+clicked_pest5.get()+") is not added to the cart.")
    def AddG6():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Dairy Milk Silk",GroceryPrice(clicked_pest6.get()),GroceryQty(clicked_pest6.get()),Spaces(40-len("Dairy Milk Silk"))])
            messagebox.showinfo("Product Status","Dairy Milk Silk Fruit & Nut ("+clicked_pest6.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Dairy Milk Silk Fruit & Nut ("+clicked_pest6.get()+") is not added to the cart.")
    def AddG7():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Yippee Noodles",GroceryPrice(clicked_pest7.get()),GroceryQty(clicked_pest7.get()),Spaces(40-len("Yippee Noodles"))])
            messagebox.showinfo("Product Status","Yippee Noodles Magic Masala ("+clicked_pest7.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Yippee Noodles Magic Masala ("+clicked_pest7.get()+") is not added to the cart.")
    def AddG8():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Mixed Fruit Jam",GroceryPrice(clicked_pest8.get()),GroceryQty(clicked_pest8.get()),Spaces(40-len("Mixed Fruit Jam"))])
            messagebox.showinfo("Product Status","Kissan Mixed Fruit Jam ("+clicked_pest8.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Kissan Mixed Fruit Jam ("+clicked_pest8.get()+") is not added to the cart.")
    def AddG9():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Mango Pickle",GroceryPrice(clicked_pest9.get()),GroceryQty(clicked_pest9.get()),Spaces(40-len("Mango Pickle"))])
            messagebox.showinfo("Product Status","Mother's Recipe Mango Pickle ("+clicked_pest9.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Mother's Recipe Mango Pickle ("+clicked_pest9.get()+") is not added to the cart.")
    def AddG10():
        global pest_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            pest_list.append(["Parle's Wafers",GroceryPrice(clicked_pest10.get()),GroceryQty(clicked_pest10.get()),Spaces(40-len("Parle's Wafers"))])
            messagebox.showinfo("Product Status","Parle's Cream & Onion Wafers ("+clicked_pest10.get()+") is successfully added to the cart.")
        else:
            messagebox.showinfo("Product Status","Parle's Cream & Onion Wafers ("+clicked_pest10.get()+") is not added to the cart.")
    add_grocery1=Button(lf_grocery1,text="Add Item",bg="green",fg="white",font="times 9 bold",command=AddG1).place(x=60,y=245)
    add_grocery2=Button(lf_grocery2,text="Add Item",bg="green",fg="white",font="times 9 bold",command=AddG2).place(x=60,y=245)
    add_grocery3=Button(lf_grocery3,text="Add Item",bg="green",fg="white",font="times 9 bold",command=AddG3).place(x=60,y=245)
    add_grocery4=Button(lf_grocery4,text="Add Item",bg="green",fg="white",font="times 9 bold",command=AddG4).place(x=60,y=245)
