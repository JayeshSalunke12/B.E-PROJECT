...
canvas.pack()
text_var="Crop Recommendation and Leaf Disease Detection"
...
d2.place(x=1200,y=350)


d3=tk.Button(root,text="Sign Up",command=Register,width=20,height=2,bd=0,background="#17202A",foreground="white",font=("times new roman",14,"bold"))
d3.place(x=1200,y=460)
